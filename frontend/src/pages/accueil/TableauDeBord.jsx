...
const ecoles = [
  ...
  },
  {
    ...
    logo: '/cme-logo.png',
    matieres: [
      { nom: 'Culture Générale', progression: 0, couleur: '#4CC9A8' },
      { nom: 'Culture Scientifique', progression: 0, couleur: '#7BC94C' },
      { nom: 'Anglais', progression: 0, couleur: '#4C9AC9' },
      { nom: 'Français', progression: 0, couleur: '#C9A84C' },
    ],
    couleur: '#4CC9A8',
    site: '#',
