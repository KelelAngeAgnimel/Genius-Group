...
const ecoles = [
  {
    ...
    roles: ['etudiant_inphb', 'etudiant_both', 'professeur', 'admin']
  },
  {
    sigle: 'ESATIC',
    ...
    roles: ['etudiant_esatic', 'etudiant_both', 'professeur', 'admin']
  },
]
...
export default function Ressources() {
  ...
  // Vérifier si l'étudiant peut accéder à cette école
  ...
  const chargerRessources = async () => {
    ...
    try {
      ...
      if (data.ressources) {
        // Filtrer par concours de l'école sélectionnée
    ...
    <div className="p-4 md:p-6 min-h-screen" style={{ background: '#f8f7f4' }}>
      ...
      {matiereSelectionnee && (
        <div>
          ...
          {/* Erreur */}
          {erreur && (
            <div className="text-center py-8 text-sm text-red-400">{erreur}</div>
          )}
